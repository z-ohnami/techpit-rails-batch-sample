...
RSpec.describe WeeklyRanksUpdator, type: :model do
  ...
  describe '.call' do
    ...
    shared_examples 'ランキング情報更新処理の検証' do
      ...
      context 'スコア所持ユーザーが複数いる場合' do
        ...
        it 'weekly_ranksテーブルにデータが作成される' do
          ...
          ranks = WeeklyRank.all.order(:rank)
      ...
      context 'スコア所持ユーザーがいるが、期間外のスコアのみの場合' do
        before do
          ...
          create(:user_score, user: user3, score: 1, received_at: '2019-08-07 10:00:00')
          create(:user_score, user: user3, score: 1, received_at: '2019-08-07 10:00:00')
          create(:user_score, user: user3, score: 1, received_at: '2019-08-07 10:00:00')
    ...
    context '過去のランキング情報が残っている場合' do
      before do
        create(:weekly_rank, user: user1, rank: 3, score: 10)
        create(:weekly_rank, user: user2, rank: 2, score: 20)
        create(:weekly_rank, user: user3, rank: 1, score: 31)
      end
